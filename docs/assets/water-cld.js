        ...
        waterKernel.onReady('cy', (C) => {
          try {
            ...
            if (!C) {
              ...
              if (!C) { console.warn('[CLD] cy instance missing in onReady(cy); aborting add'); return; }
            }
            if (typeof C.startBatch !== 'function') {
              console.warn('[CLD] cy instance invalid (no startBatch); aborting add');
              return;
            }
